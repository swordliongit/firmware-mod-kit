...
s = m:section(NamedSection, wdev:name(), "wifi_device", translate("Device Configuration"))
s.addremove = false
...
s = m:section(NamedSection, wnet.sid, "wifi_iface", translate("Interface Configuration"))
ifsection = s
s.addremove = false
s.anonymous = true
