...
s = m:section(NamedSection, arg[1], "Classification", translate("Qos"))
s.anonymous = true
s.addremove = false
...
DSCPMarkValue = s:option(Value, "DSCPMarkValue", translate("DSCPMarkValue"))


 P_Value = s:option(Value, "P_Value", translate("P_Value"))
 P_Value.datatype =  "range(0,7)"
 name= s:option(Value, "name", translate("Key Word"))  
