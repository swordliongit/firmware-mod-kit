...
for k, v in pairs(wireless) do
	if v[".type"] == "wifi_iface" then
		table.insert(ifaces, v)
	end
end

wlcursor:foreach("wireless", "wifi_device",
	function(section)
...
s = m:section(NamedSection, wifidevs[1], "wifi_device", translate("Devices"))
s.addremove = false
...
s = m:section(TypedSection, "wifi_iface", translate("Local Network"))
s.anonymous = true
s.addremove = false
...
local devs = {}
luci.model.uci.cursor():foreach("wireless", "wifi_device",
	function (section)
